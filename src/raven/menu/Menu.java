...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"~BIBLIOTECA~"},
        {"Gerenciamento de Livros", "Cadastrar Livro", "Lista de Livros", "Pesquisa de Livros"},
        {"Gerenciamento de Usuários", "Cadastrar Usuário", "Lista de Usuários"},
        
        {"~EMPRÉSTIMOS~"},
        {"Empréstimos e Devoluções", "Novo Empréstimo", "Registrar Devolução", "Histórico de Empréstimos"},
    ...
    private final String headerName = "Biblioteca";
